...
from src.functions.mrc_metrics import compute_exact, compute_f1, compute_rouge_w, normalize_answer
...
def get_raw_scores(examples, preds):
    ...
    for example in examples:
        ...
        gold_answers = [normalize_answer(example.answers["answer_text"])]
        # gold_answers = [normalize_answer(answer) for answer in example.answers if normalize_answer( ["answer_text"])]
